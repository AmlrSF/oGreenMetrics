...
const ViewReport = ({ id }) => {
  ...
  const calculateTotalEmissions = useMemo(() => {
    ...
    if (memoizedReport.scope1Data) {
      if (memoizedReport.scope1Data.fuelCombution?.length > 0) {
        scope1Total +=
          memoizedReport.scope1Data.fuelCombution[0].totalEmissions || 0;
      }
      if (memoizedReport.scope1Data.production?.length > 0) {
        scope1Total +=
          memoizedReport.scope1Data.production[0].totalEmissions || 0;
      }
    }
    ...
    if (memoizedReport.scope2Data) {
      if (Array.isArray(memoizedReport.scope2Data.cooling)) {
        if (memoizedReport.scope2Data.cooling.length > 0) {
          scope2Total +=
            memoizedReport.scope2Data.cooling[0].totalEmissions || 0;
        }
        if (memoizedReport.scope2Data.heating?.length > 0) {
          scope2Total +=
            memoizedReport.scope2Data.heating[0].totalEmissions || 0;
        }
        if (memoizedReport.scope2Data.energyConsumption?.length > 0) {
          scope2Total +=
            memoizedReport.scope2Data.energyConsumption[0].emissions || 0;
        }
      } else {
        ...
        scope2Total +=
          memoizedReport.scope2Data.energyConsumption?.emissions || 0;
      }
    }

    // Scope 3
    if (memoizedReport.scope3Data) {
      scope3Total += parseFloat(
        memoizedReport.scope3Data.businessTravelEmissions || 0
      );
      scope3Total += parseFloat(
        memoizedReport.scope3Data.transportEmissions || 0
      );
      scope3Total += parseFloat(memoizedReport.scope3Data.dechetEmissions || 0);
      scope3Total += parseFloat(
        memoizedReport.scope3Data.capitalGoodEmissions || 0
      );
    }
  ...
  const getScope1Details = () => {
    if (!memoizedReport || !memoizedReport.scope1Data)
      return { fuelEmissions: 0, productionEmissions: 0 };
  ...
  const getScope2Details = () => {
    if (!memoizedReport || !memoizedReport.scope2Data)
      return {
        coolingEmissions: 0,
        heatingEmissions: 0,
        energyConsumptionEmissions: 0,
      };
  ...
  const getScope3Details = () => {
    if (!memoizedReport || !memoizedReport.scope3Data)
      return {
    ...
    const businessTravelEmissions = parseFloat(
      memoizedReport.scope3Data.businessTravelEmissions || 0
    );
    const transportEmissions = parseFloat(
      memoizedReport.scope3Data.transportEmissions || 0
    );
    const wasteEmissions = parseFloat(
      memoizedReport.scope3Data.dechetEmissions || 0
    );
    const capitalGoodEmissions = parseFloat(
      memoizedReport.scope3Data.capitalGoodEmissions || 0
    );
  ...
  const getFuelTypes = () => {
    if (
      !memoizedReport ||
      !memoizedReport.scope1Data?.fuelCombution?.[0]?.machines
    ) {
      return [];
    }
    ...
    machines.forEach((machine) => {
      ...
      fuelTypesMap.set(
        fuelType,
        (fuelTypesMap.get(fuelType) || 0) + machine.co2Emission
      );
    });

    return Array.from(fuelTypesMap).map(([type, emissions]) => ({
      type,
      emissions,
    }));
  };
  ...
  const getCoolingTypes = () => {
    ...
    coolers.forEach((cooler) => {
      ...
      coolingTypesMap.set(
        type,
        (coolingTypesMap.get(type) || 0) + cooler.emissions
      );
    });

    return Array.from(coolingTypesMap).map(([type, emissions]) => ({
      type,
      emissions,
    }));
  };
  ...
  const getHeatingTypes = () => {
    ...
    heaters.forEach((heater) => {
      ...
      heatingTypesMap.set(
        type,
        (heatingTypesMap.get(type) || 0) + heater.emissions
      );
    });

    return Array.from(heatingTypesMap).map(([type, emissions]) => ({
      type,
      emissions,
    }));
  };
  ...
  const getTransportModes = () => {
    ...
    memoizedReport.scope3Data.transport.forEach((item) => {
      ...
      transportModes.set(
        mode,
        (transportModes.get(mode) || 0) + parseFloat(item.emissions)
      );
    });

    return Array.from(transportModes).map(([mode, emissions]) => ({
      mode,
      emissions,
    }));
  };
  ...
  const getWasteTypes = () => {
    ...
    memoizedReport.scope3Data.dechet.forEach((item) => {
      ...
      wasteTypes.set(
        type,
        (wasteTypes.get(type) || 0) + parseFloat(item.emissions)
      );
    });

    return Array.from(wasteTypes).map(([type, emissions]) => ({
      type,
      emissions,
    }));
  };
          ...
          <div className="d-flex align-items-center justify-content-between w-full">
            <div className="d-flex align-items-center">
              ...
              <h2 className="ms-3 mb-0">
                {memoizedReport.name || "Environmental Impact Report"}
              </h2>
            </div>
          ...
          <div className="row">
            <div className="col-lg-8">
              <p className="text-secondary mb-3">
                {memoizedReport.description ||
                  "Comprehensive report of your company's environmental impact"}
              </p>
              <div className="d-flex mb-2">
                ...
                <div className="me-4 d-flex align-items-center">
                  ...
                  <span>
                    Type:{" "}
                    {memoizedReport.detailLevel === "detailed"
                      ? "Detailed Report"
                      : "Summary Report"}
                  </span>
                </div>
                <div className="d-flex align-items-center">
                  ...
                  <span>
                    Graphique:{" "}
                    {memoizedReport.includeCharts === "yes"
                      ? "Included"
                      : "Not Included"}
                  </span>
                </div>
              ...
              <div className="mt-3 mb-3">
                Scopes included:
                {memoizedReport.scope1 && (
                  <span className="badge bg-blue-lt ms-2">Scope 1</span>
                )}
                {memoizedReport.scope2 && (
                  <span className="badge bg-purple-lt ms-2">Scope 2</span>
                )}
                {memoizedReport.scope3 && (
                  <span className="badge bg-green-lt ms-2">Scope 3</span>
                )}
              </div>
            </div>
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col">
                      ...
                      <div className="text-secondary">
                        {formatNumber(calculateTotalEmissions.total)} tCO₂
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card-body">
                    <div className="mb-3">
                      <div className="d-flex align-items-center justify-content-between mb-1">
                        ...
                        <strong>
                          {formatNumber(calculateTotalEmissions.scope1)} tCO₂
                        </strong>
                      </div>
                    ...
                    <div className="mb-3">
                      <div className="d-flex align-items-center justify-content-between mb-1">
                        <span className="d-flex align-items-center">
                          <span className="badge bg-purple-lt me-2">
                            Scope 2
                          </span>
                          Émissions indirectes
                        </span>
                        <strong>
                          {formatNumber(calculateTotalEmissions.scope2)} tCO₂
                        </strong>
                      </div>
                      <div className="progress mb-3">
                        <div
                    ...
                    <div className="mb-3">
                      <div className="d-flex align-items-center justify-content-between mb-1">
                        <span className="d-flex align-items-center">
                          <span className="badge bg-green-lt me-2">
                            Scope 3
                          </span>
                          Émissions indirectes
                        </span>
                        <strong>
                          {formatNumber(calculateTotalEmissions.scope3)} tCO₂
                        </strong>
                      </div>
                      <div className="progress mb-3">
                        <div
                          ...
                          style={{
                            width: `${
                              calculateTotalEmissions.total
                                ? (calculateTotalEmissions.scope3 /
                                    calculateTotalEmissions.total) *
                                  100
                                : 0
                            }%`,
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <dl className="row">
                      ...
                      <dd className="col-7">
                        {new Date(
                          memoizedReport.createdAt
                        ).toLocaleDateString()}
                      </dd>
                      <dt className="col-5">Scopes inclus :</dt>
                      <dd className="col-7">
                        {memoizedReport.scope1 && (
                          <span className="badge bg-blue-lt me-1">Scope 1</span>
                        )}
                        {memoizedReport.scope2 && (
                  ...
                  <div className="card-header">
                    ...
                    <div className="card-actions">
                      <span className="badge bg-blue text-white">
                        {memoizedReport.scope1Data?.fuelCombution?.[0]?.totalEmissions?.toLocaleString() ||
                          0}{" "}
                        tCO₂
                      </span>
                    </div>
                  ...
                  <div className="card-body">
                    {getFuelTypes().length > 0 ? (
                        ...
                        <table className="table table-vcenter card-table table-striped">
                          ...
                          <tbody>
                            {getFuelTypes().map((fuelType, index) => {
                              const machines =
                                memoizedReport.scope1Data?.fuelCombution?.[0]?.machines?.filter(
                                  (m) => m.typeDeCarburant === fuelType.type
                                ) || [];
                              const totalQuantity = machines.reduce(
                                (sum, m) => sum + m.quantite,
                                0
                              );
                              const percentage =
                                (fuelType.emissions /
                                  (memoizedReport.scope1Data?.fuelCombution?.[0]
                                    ?.totalEmissions || 1)) *
                                100;
                              return (
                                <tr key={index}>
                                  ...
                                  <td>
                                    <strong>
                                      {fuelType.emissions.toLocaleString()}
                                    </strong>
                                  </td>
                                  <td>
                                    <div className="d-flex align-items-center">
                      ...
                      <div className="alert alert-info">
                        Aucune donnée sur la combustion de carburant disponible.
                      </div>
                    )}
                  </div>
                </div>
              ...
              <div className="col-md-12 mt-3">
                <div className="card">
                  <div className="card-header">
                    ...
                    <div className="card-actions">
                      <span className="badge bg-blue text-white">
                        {memoizedReport.scope1Data?.production?.[0]?.totalEmissions?.toLocaleString() ||
                          0}{" "}
                        tCO₂
                      </span>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="table-responsive">
                      <table className="table table-vcenter card-table table-striped">
                        ...
                        <tbody>
                          {memoizedReport.scope1Data?.production?.[0]?.products?.map(
                            (product, index) => (
                              <tr key={product._id || index}>
                                <td>{product.nom}</td>
                                <td>
                                  <span className="badge bg-azure-lt">
                                    {product.ligneDeProduction}
                                  </span>
                                </td>
                                <td>{product.quantite.toLocaleString()}</td>
                                <td>
                                  <strong>
                                    {product.co2Emission.toLocaleString()}
                                  </strong>
                                </td>
                              </tr>
                            )
                ...
                <div className="card">
                    ...
                    <div className="card-actions">
                      <span className="badge bg-purple text-white">
                        {Array.isArray(memoizedReport.scope2Data?.cooling)
                          ...
                          : memoizedReport.scope2Data?.cooling?.totalEmissions?.toLocaleString() ||
                            0}{" "}
                        tCO₂
                      </span>
                    </div>
                  ...
                  <div className="card-body">
                    {getCoolingTypes().length > 0 ? (
                        ...
                        <table className="table table-vcenter card-table table-striped">
                          ...
                          <tbody>
                            {getCoolingTypes().map((coolingType, index) => {
                              const coolers =
                                (Array.isArray(
                                  memoizedReport.scope2Data?.cooling
                                )
                                  ? memoizedReport.scope2Data?.cooling?.[0]
                                      ?.coolers
                                  : memoizedReport.scope2Data?.cooling?.coolers
                                )?.filter((c) => c.type === coolingType.type) ||
                                [];
                              const totalEnergy = coolers.reduce(
                                (sum, c) => sum + (c.energy || 0),
                                0
                              );
                              const totalEmissions = Array.isArray(
                                memoizedReport.scope2Data?.cooling
                              )
                                ? memoizedReport.scope2Data?.cooling?.[0]
                                    ?.totalEmissions
                                : memoizedReport.scope2Data?.cooling
                                    ?.totalEmissions || 1;
                              const percentage =
                                (coolingType.emissions / totalEmissions) * 100;
                              return (
                                <tr key={index}>
                                  <td>
                                  ...
                                  <td>
                                    <strong>
                                      {coolingType.emissions.toLocaleString()}
                                    </strong>
                                  </td>
                                  <td>
                                    <div className="d-flex align-items-center">
                      ...
                      <div className="alert alert-info">
                        Aucune donnée sur les systèmes de refroidissement
                        disponible.
                      </div>
                    )}
                  </div>
                ...
                <div className="card">
                    ...
                    <div className="card-actions">
                      <span className="badge bg-purple text-white">
                        {Array.isArray(memoizedReport.scope2Data?.heating)
                          ...
                          : memoizedReport.scope2Data?.heating?.totalEmissions?.toLocaleString() ||
                            0}{" "}
                        tCO₂
                      </span>
                    </div>
                  ...
                  <div className="card-body">
                    {getHeatingTypes().length > 0 ? (
                        ...
                        <table className="table table-vcenter card-table table-striped">
                          ...
                          <tbody>
                            {getHeatingTypes().map((heatingType, index) => {
                              const heaters =
                                (Array.isArray(
                                  memoizedReport.scope2Data?.heating
                                )
                                  ? memoizedReport.scope2Data?.heating?.[0]
                                      ?.heaters
                                  : memoizedReport.scope2Data?.heating?.heaters
                                )?.filter((h) => h.type === heatingType.type) ||
                                [];
                              const totalEnergy = heaters.reduce(
                                (sum, h) => sum + (h.energy || 0),
                                0
                              );
                              const totalEmissions = Array.isArray(
                                memoizedReport.scope2Data?.heating
                                ...
                                : memoizedReport.scope2Data?.heating
                                    ?.totalEmissions || 1;
                              const percentage =
                                (heatingType.emissions / totalEmissions) * 100;
                              return (
                                <tr key={index}>
                                  <td>
                                  ...
                                  <td>
                                    <strong>
                                      {heatingType.emissions.toLocaleString()}
                                    </strong>
                                  </td>
                                  <td>
                                    <div className="d-flex align-items-center">
                      ...
                      <div className="alert alert-info">
                        Aucune donnée sur les systèmes de chauffage disponible.
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="card">
                  <div className="card-header">
                    ...
                    <div className="card-actions">
                      <span className="badge bg-purple text-white">
                        {Array.isArray(
                          memoizedReport.scope2Data?.energyConsumption
                        )
                          ? memoizedReport.scope2Data?.energyConsumption?.[0]?.emissions?.toLocaleString()
                          : memoizedReport.scope2Data?.energyConsumption?.emissions?.toLocaleString() ||
                            0}{" "}
                        tCO₂
                      </span>
                    </div>
                        ...
                        <dl className="row">
                          ...
                          <dd className="col-7">
                            {Array.isArray(
                              ...
                              ? memoizedReport.scope2Data
                                  ?.energyConsumption?.[0]?.country
                              : memoizedReport.scope2Data?.energyConsumption
                                  ?.country || "N/A"}
                          </dd>
                          ...
                          <dd className="col-7">
                            {Array.isArray(
                              ...
                              : memoizedReport.scope2Data?.energyConsumption?.yearlyConsumption?.toLocaleString() ||
                                0}{" "}
                            kWh
                          </dd>
                        ...
                        <div className="alert alert-info">
                          <div className="d-flex">
                            ...
                            <div>
                              ...
                              d'électricité sont calculées en fonction des
                              facteurs d'émission spécifiques au pays.
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="card-header">
                    ...
                    <div className="card-actions">
                      <span className="badge bg-green text-white">
                        {parseFloat(
                          memoizedReport.scope3Data?.businessTravelEmissions ||
                            0
                        ).toLocaleString()}{" "}
                        tCO₂
                      </span>
                  ...
                  <div className="card-body">
                    <div className="table-responsive">
                      <table className="table table-vcenter card-table table-striped">
                        ...
                        <tbody>
                          {memoizedReport.scope3Data?.businessTravel?.map(
                            (travel, index) => (
                              <tr key={travel._id || index}>
                                ...
                                <td>{travel.type}</td>
                                <td>
                                  {parseFloat(travel.distance).toLocaleString()}
                                </td>
                                <td>
                                  <strong>
                                    {parseFloat(
                  ...
                  <div className="card-body">
                    <div className="table-responsive">
                      <table className="table table-vcenter card-table table-striped">
                        ...
                        <tbody>
                          {memoizedReport.scope3Data?.transport?.map(
                            (transport, index) => (
                              <tr key={transport._id || index}>
                                <td>{transport.purpose}</td>
                                <td>
                                  <span className="badge bg-indigo-lt">
                                    {transport.mode} - {transport.type}
                                  </span>
                                </td>
                                <td>
                                  {parseFloat(transport.poids).toLocaleString()}
                                </td>
                                <td>
                                  {parseFloat(
                                    transport.distance
                    ...
                    {getWasteTypes().length > 0 ? (
                      <div className="table-responsive">
                        <table className="table table-vcenter card-table table-striped">
                          ...
                          <tbody>
                            {memoizedReport.scope3Data?.dechet?.map(
                              (waste, index) => (
                                <tr key={waste._id || index}>
                                  ...
                                  <td>{waste.methode}</td>
                                  <td>
                                    {parseFloat(waste.poids).toLocaleString()}
                                  </td>
                                  <td>
                                    <strong>
                                      {parseFloat(
                      ...
                      <div className="alert alert-info">
                        Aucune donnée sur la gestion des déchets disponible.
                      </div>
                    )}
                  </div>
                </div>
                    ...
                    {memoizedReport.scope3Data?.capitalGoods?.length > 0 ? (
                      <div className="table-responsive">
                        <table className="table table-vcenter card-table table-striped">
                          ...
                          <tbody>
                            {memoizedReport.scope3Data.capitalGoods.map(
                              (good, index) => (
                                <tr key={good._id || index}>
                                  ...
                                  <td>
                                    {parseFloat(good.quantity).toLocaleString()}
                                  </td>
                                  <td>
                                    <strong>
                                      {parseFloat(
                      ...
                      <div className="alert alert-info">
                        Aucune donnée sur les biens d'équipement disponible.
                      </div>
                    )}
                  </div>
                </div>
