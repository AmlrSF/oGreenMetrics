                      ...
                      <div className="col">
                        <div className="d-flex align-items-center justify-content-between  ">
                          <div>
                            ...
                            <div className=" mt-1 badge bg-blue-lt">
                              {company.industrie}
                            </div>
                          </div>
                          <div className="d-flex align-items-center gap-2 ms-3">
                            <span
                              className={`flag flag-country-${countryCode} flag-xl ms-2`}
                            ></span>
                          </div>
                        </div>
                      </div>
                ...
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="icon icon-tabler icon-tabler-address-book me-1"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        strokeWidth="2"
                    ...
                    <div className="datagrid">
                      <div className="datagrid-item">
                        <div className="datagrid-title">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="icon icon-tabler icon-tabler-mail me-1"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            strokeWidth="2"
                      ...
                      <div className="datagrid-item">
                        <div className="datagrid-title">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="icon icon-tabler icon-tabler-phone me-1"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            strokeWidth="2"
                      ...
                      <div className="datagrid-item">
                        <div className="datagrid-title">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="icon icon-tabler icon-tabler-map-pin me-1"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            strokeWidth="2"
                ...
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="icon icon-tabler icon-tabler-building-skyscraper me-1"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        strokeWidth="2"
                    ...
                    <div className="datagrid">
                      <div className="datagrid-item">
                        <div className="datagrid-title">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="icon icon-tabler icon-tabler-category me-1"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            strokeWidth="2"
                      ...
                      <div className="datagrid-item">
                        <div className="datagrid-title">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="icon icon-tabler icon-tabler-calendar me-1"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            strokeWidth="2"
                      ...
                      <div className="datagrid-item">
                        <div className="datagrid-title">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="icon icon-tabler icon-tabler-id me-1"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            strokeWidth="2"
                        ...
                        <div className="datagrid-content font-monospace">
                ...
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="icon icon-tabler icon-tabler-chart-pie me-1"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        strokeWidth="2"
                ...
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="icon icon-tabler icon-tabler-user me-1"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        strokeWidth="2"
                        ...
                        <div className="row d-flex align-items-center mb-3">
                          <div className="col-auto">
                            <span className="avatar avatar-md">
                              {company.userId.prenom.charAt(0).toUpperCase()}
                              {company.userId.nom.charAt(0).toUpperCase()}
                            </span>
                          </div>
                          <div className="col">
                        ...
                        <div className="datagrid">
                          <div className="datagrid-item">
                            <div className="datagrid-title">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="icon icon-tabler icon-tabler-calendar-plus me-1"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                strokeWidth="2"
                          ...
                          <div className="datagrid-item">
                            <div className="datagrid-title">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="icon icon-tabler icon-tabler-refresh me-1"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                strokeWidth="2"
