  ...
  return (
    <div className="page page-center bg-body-tertiary">
      <div ref={alertRef}>
        {alert.show && (
          <div
            className={`alert alert-${alert.type} alert-dismissible position-fixed top-0 start-50 translate-middle-x mt-3`}
            role="alert"
          >
            {alert.message}
            <button
              ...
              <div className="col-12 col-md-6">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-muted small">
                    Entrez votre nouveau mot de passe et confirmez-le pour
