      ...
      justify-content-center ">
        <div className="col-md-6 px-4 mb-8 mb-md-0">
          ...
          <p className="text-muted mb-4">
            ...
            l'accompagnement d'experts pour amorcer votre transition bas carbone
            et réduire l'empreinte carbone de votre entreprise, tout cela en
            moins de 15 min de connexion.
          </p>
          <Link
            href="/contact"
