...
const websiteMenuItems = [
  ...
  { icon: List, label: "Sites", href: "/Dashboard/Regular/Sites" },
...
const tabs = {
  ...
  "biens-services": {
    ...
    headers: ["Titre", "Type",  "sousType", 
      "Quantite", "Emissions","createdAt","Action"],
    fields: [
      {
        name: "titre",
        label: "Titre",
      ...
      },
      {
        ...
        dynamicOptions: {
          ...
          WasteSector: [
            { value: "MunicipalWaste", label: "Municipal solid waste treatment" },
