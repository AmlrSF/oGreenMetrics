...
const userMenuItems = [
  ...
  { icon: GanttChartSquare, label: "Scope 1", href: "/Dashboard/User/scope1" },
  { icon: Gauge, label: "Scope 2", href: "/Dashboard/User/scope2" },
  { icon: BarChart3, label: "Scope 3", href: "/Dashboard/User/scope3" },
  { icon: FileText, label: "Reports", href: "/Dashboard/User/reports" },
  { icon: Target, label: "Goals", href: "/Dashboard/User/goals" },
