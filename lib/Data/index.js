...
const menuItems = [
  { icon: IconLayoutDashboard, label: "Tableau de bord", href: "/Dashboard/Admin" },
  {
    icon: IconUsers,
  ...
  { icon: IconSettings, label: "Paramètres", href: "/Dashboard/Admin/Settings" },
  { icon: IconUserCircle, label: "Profil", href: "/Dashboard/Admin/profile" },
];
...
const websiteMenuItems = [
  { icon: IconLayoutDashboard, label: "Tableau de bord", href: "/Dashboard/Regular" },
  { icon: IconList, label: "Sites", 
  ...
  },
  {
    icon: IconSettings,
    label: "Paramètres",
    href: "/Dashboard/Regular/Settings",
  },
];
